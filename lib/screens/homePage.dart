    ...
    return ScreenTimeWidget(
      ...
      child: Scaffold(
        ...
        child: SingleChildScrollView(
            ...
            child: Opacity(
              opacity: p.isLoading && p.isiloadingFor == "" ? 0.7 : 1,
              child: Skeletonizer(
                      ...
                      enableSwitchAnimation:
                          p.isLoading && p.isiloadingFor == "",
                      enabled: p.isLoading && p.isiloadingFor == "",
                      child: Column(
                  ...
                  .animate(
                      ...
                      onPlay: (controller) => controller.repeat(
                          count: 2,
                          period: Duration(
                              seconds: p.isLoading && p.isiloadingFor == ""
                                  ? 2
                                  : 100)))
                  .shimmer(
...
class MsgChartWidget extends StatelessWidget {
  final List dataList;
  MsgChartWidget({super.key, required this.dataList});
